...
const btnMolt = document.querySelector(".btnMolt");
const btnDiv = document.querySelector(".btnDiv");
const btnSott = document.querySelector(".btnSott");
...
btnUguale.addEventListener("click", () => {
  const num1 = parseFloat(valore1);
  const num2 = parseFloat(valore2);

  if (isNaN(num1) || isNaN(num2)) {
    aggiornaSchermo("Inserisci valori numerici validi!");
    return;
  }
